...
class TouchableWithoutFeedbackWrapper extends React.Component<*> {
    render() {
        const { onPress, onLongPress, testID, accessibilityLabel, ...props } = this.props
...
class TabBarBottom extends React.Component<Props> {
    ...
    render() {
        const { navigation, activeBackgroundColor, inactiveBackgroundColor, onTabPress, onTabLongPress, safeAreaInset, style, tabStyle } = this.props
